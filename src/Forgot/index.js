...
import { Resendemailverificationotp,Forgotpasswordvarifyotpurl } from '../../Apis/CallApis/URL';
...
const handleresend=async()=>{
 ...
 const datasend = {
  url:Forgotpasswordvarifyotpurl,
      data: formdata
    ...
    <Formik
      ...
      {({
        ...
        <View style={styles.Container}>
          ...
          {stat==400&&(
             <Text style={styles.eror}>Enter correct otp</Text>
          )}
